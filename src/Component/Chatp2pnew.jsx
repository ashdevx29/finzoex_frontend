...
function Home() {
  ...
  return (
    <div className="">
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12}>
                                    ...
                                    <div>
                                      ...
                                      {profileDataref.current._id.toString() !=
                                        ...
                                        <>
                                          ...
                                          {bankDataref.current ? (<h5>Buyer Payment Methods</h5>) : ("")}
                                          {confirmp2porderref.current != undefined && bankDataref.current == "" ? (
                                            ""
                                          ) : (
                                            <div className="payment_tab_p2p p-0">
                                              ...
                                              <div className="tab-content">
                                                ...
                                                <div id="menu2" className="tab-pane fade">
                                                  ...
                                                  {bankDataref.current && bankDataref.current.Paytm_Number !=
                                                    undefined && bankDataref.current.Paytm_Number !=
                                                    "" ? (
                                                    <div>
                                                      {/* <label>Paytm</label> */}
                                      ...
                                      {profileDataref.current._id.toString() ==
                                        ...
                                        <>
                                          ...
                                          {bankDataref.current ? (<h5>Seller Payment Methods</h5>) : ("")}
                                          {confirmp2porderref.current && p2pbankDataref.current == "" ? (
                                            ""
                                          ) : (
                                            <div className="payment_tab_p2p p-0">
                                              <ul className="nav nav-tabs">
                                ...
                                {orderTyperef.current == "Buy" &&
                                  ...
                                  <div className="timer">
                                    ...
                                    <p>
                                    - Do not accept third party payment
                                    </p>
                                    <p>
                                    - If you are not pay within {(payTimeref.current < 60) ? payTimeref.current + " minutes" : (payTimeref.current / 60 == 1) ? payTimeref.current / 60 + " hour" : payTimeref.current / 60 + " hours"}, order will be cancelled automatically
                                    </p>
                                  </div>
                                ) : (
                                  ""
                              ...
                              <div className="msg_section">
                                ...
                                <div className="message ">
                                  <div>
                                    <span>1m ago</span>
                                    <img
                                      src={new URL("../img/qr.png", import.meta.url).href}
                                      className=""
                                    />
                                  </div>
                                </div> */}
      ...
      <div id="success_msg" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered ">
          <div className="modal-content">
            <div className="modal-body model_confirms">
      ...
      <div id="raise_dispute_buy" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered ">
          <div className="modal-content">
            <div className="modal-body model_confirms">
              <h1> Raise Dispute </h1>
      ...
      <div id="raise_dispute_sell" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered ">
          <div className="modal-content">
            <div className="modal-body model_confirms">
              <h1> Raise Dispute </h1>
