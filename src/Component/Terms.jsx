          ...
          <div className="row justify-center">
            <div className="col-lg-10">
              <div className="mx-auto u-para--readable">
                <span className="u-para--readable mb-6">
                ...
                <h3 className="text-xl font-bold my-4">Accounts</h3>
                ...
                <p className="u-para--readable mb-6">
                  ...
                  may imply legal action and we may suspend or stop providing
                  our Services to you if you do not comply with our terms or
                ...
                <h3 className="text-xl font-bold my-4">Termination</h3>
                <p className="u-para--readable mb-6">
                ...
                <h3 className="text-xl font-bold my-4">Changes</h3>
                <p className="u-para--readable mb-6">
                ...
                <h3 className="text-xl font-bold my-4">Contact Us</h3>
                <p className="u-para--readable mb-6">
                  If you have any questions about this Privacy Policy, please
                  contact us at{" "}
                  <a
                    href="mailto:hi@Taikonz.com"
                    target="_blank"
