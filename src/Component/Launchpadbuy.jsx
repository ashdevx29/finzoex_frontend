...
import Time from "../Component/Countdown";
...
function Home() {
  ...
  useEffect(() => {
    ...
    var fetchPair = urls.split("launchbuy/")[1];
    if (fetchPair) {
  ...
  return (
    <div className="">
      ...
      <div id="launchpad_doce" className="modal launchpad_doce fade" role="dialog">
