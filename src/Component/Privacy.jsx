        ...
        <div className="container">
          <div className="row justify-center">
            <div className="col-lg-10">
              <div className="mx-auto u-para--readable">
                <span>Last updated: 26 July 2022</span>
                ...
                <ol className="list-decimal pl-8">
                  <li className="mb-4">Managing your information and accounts;</li>
                  <li className="mb-4">
                  ...
                  <li className="mb-4">Allowing you to register for events.</li>
                  <li className="mb-4">
                  ...
                  <li className="mb-4">Developing new products and Services;</li>
                  <li className="mb-4">Ensuring internal quality control;</li>
                  <li className="mb-4">
                  ...
                  <li className="mb-4">Enforcing our terms and policies; and</li>
                  <li className="mb-4">
                ...
                <h3 className="text-xl font-bold my-4">2.1.Automated profiling</h3>
                <h4>
                ...
                <h4 className="text-xl font-bold my-4">3.2.Affiliates-</h4>
                <p className="u-para--readable mb-6">
                ...
                <h3 className="text-xl font-bold my-4">IV. YOUR CHOICES</h3>
                <h4>4.1.General-</h4>
                <p className="u-para--readable mb-6">
                ...
                <h4 className="text-xl font-bold my-4">ii) Mobile Devices</h4>
                <p>
                ...
                <h4 className="text-xl font-bold my-4">iii) Do Not Track</h4>
                <ol className="list-decimal pl-8">
                  <li className="mb-4">
                ...
                <h3 className="text-xl font-bold my-4">4.2.Your Privacy Rights</h3>
                <p className="u-para--readable mb-6">
                ...
                <h3 className="text-xl font-bold my-4">V. DATA RETENTION</h3>
                <p className="u-para--readable mb-6">
                ...
                <h3 className="text-xl font-bold my-4">X. CONTACT US</h3>
                <p className="u-para--readable mb-6">
                  ...
                  us at:{" "}
                  <a href="taikonz.com" target="_blank">
                    no-reply@taikonz.com
                  </a>
                </p>
              </div>
            </div>
