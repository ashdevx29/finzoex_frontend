...
function Home() {
  ...
  const [emailValidate, setemailValidate,setemailValidateref] = useState(false);
  const [positionValidate, setpositionValidate] = useState(false);
  const [nameValidate, setnameValidate] = useState(false);
  const [serviceValidate, setserviceValidate,setserviceValidateref] = useState(false);
  ...
  const [websiteValidate, setwebsiteValidate,setwebsiteValidateref] = useState(false);
  ...
  const steps = async (count) => {
    ...
    if (count == "one") {
      await validationOne();
      console.log( setemailValidateref.current,"=-=-= setemailValidateref.current==false&&-=-==");
      console.log( setserviceValidateref.current,"=-=-= setserviceValidateref.currentf.current==false&&-=-==");
      if (
        setemailValidateref.current==false&&
        formDataOne.position != "" &&
        formDataOne.fullName != ""
        //setserviceValidateref.current==false
      ) {
    ...
    if (count == "two") {
      ...
      console.log(  setwebsiteValidateref.current,"[][[]====  setwebsiteValidateref.current=====");
      if (
        projectName != "" &&
        symbol != "" &&
        coinName != "" &&
        contractAddress != "" &&
        setwebsiteValidateref.current==false&&
        whitpaper != "" &&
        milestone != "" &&
        description != "" &&
        tokenImage != "" &&
    ...
    if (count == "three") {
   validatioThree();
   console.log(price,"-=-=inimum-=");
   console.log(softCap,"-=-=inimum-=");
    console.log(minimum,"-=-=inimum-=");
      if (
        softCap != "" &&
        hardcap != "" &&
        price != "" &&
  ...
  return (
    <div className="login_body_ bg-cover bg-coverneww">
          ...
          <div className="">
            <div className="container ">
              <div className="logo_launchpad">
                <img
                  src={new URL("../img/keedx-logo.png", import.meta.url).href}
                      ...
                      <div className="row">
                          ...
                          <div className="form-group">
                            <div className="">
                              <label htmlFor="formFile" className="form-label">
                                ...
                                <small> ( e.g. 1 XXX = 0.1 USDT)</small>
                              </label>
                              <input
                                type="number"
                                className="form-control"
                        ...
                        <div className="col-lg-6">
                          <div className="form-group">
                            ...
                            className=" block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          >
                        ...
                        btnLoader == true ?
                          (
                            ...
                            <div className="col-lg-12 row justify-content-end">
                              <button
                              type="button"
                              className="btn btn-primary w-30 mr-3"
                              data-toggle="modal"
                             data-target="#launchpad_step5"
                            >
                              Preview
                            </button>
      ...
      <div id="launchpad_step1" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-body">
              <h1>Launchpad - Step1</h1>
              <p>
                <span>Email</span>
                <span>
                {email}
              ...
              <p>
                <span>Please confirm your Full Name</span>
                <span>
                {fullName}
                </span>
              </p>
              ...
              <p>
                <span>Confirm your position with this Project</span>
                <span>
                {position}
                </span>
              </p>
              ...
              <p>
                <span>If there are someone who introduce you to this service, please provide their email here.</span>
                <span>
                {service}
                </span>
              </p>
      ...
      <div id="launchpad_step2" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-body">
              <h1>Launchpad - Step2</h1>
              <p>
              ...
              <p>
                <span>Token/Coin Full Name</span>
                <span>
                {coinName}
                </span>
              </p>
              ...
              <p>
                <span>Permanent link to your whitepaper</span>
                <span>
                {whitpaper}
                </span>
              </p>
              ...
              <p>
                <span>Detailed Roadmap and Milestones</span>
                <span>
                {milestone}
                </span>
              </p>
              ...
              <p>
                <span>Short Description of Token/Coin</span>
                <span>
                {description}
                </span>
              </p>
      ...
      <div id="launchpad_step3" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-body">
              <h1>Launchpad - Step3</h1>
              <p>
              ...
              <p>
                ...
                {moment(endtDate).format("DD-MM-YYYY")}
              </p>
              ...
              <p>
                <span>Public Sale Conversion Price</span>
                <span>
                {price}
                </span>
              </p>
      ...
      <div id="launchpad_step4" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-body">
              <h1>Launchpad - Step4</h1>
              <p>
              ...
              <p>
                <span>Please provide a link to your GitHub</span>
                <span>
                {github}
                </span>
              </p>
      ...
      <div id="launchpad_step5" className="modal launchpad_doce fade" role="dialog">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-body">
              <h1>Launchpad</h1>
