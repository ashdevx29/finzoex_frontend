                    ...
                    <div className="container padin_zero p-0">
                      <div>
                        {/* <ul className="nav nav-tabs">
                          <li className="">
                            <a data-toggle="tab" href="#wallet" className="active">
                              Wallet
                            </a>
                          </li>
                          <li>
                      ...
                      <div className="table_section_ padin_zero p-0">
                        <div className="tab-content">
                          <div id="wallet" className="tab-pane fade in active show">
                                ...
                                <table className="table">
                                  <thead>
                                    <tr>
                                      ...
                                      {/* <th scope="col" className="text_222">24h Market</th> */}
                                      <th scope="col" className="text_222"></th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    {balanceDetails &&
                                        ...
                                        <div className="form_">
                                          <form className="form_wiuthdrawl ">
                                            ...
                                            depositDet.currencyType == "2" ? (
                                              <>
                                                <label>Network</label>
                                                <div className="prime_deposit width_100">
                                                  <input
                                                    type="text"
                                                    value={network}
                                                    disabled
                            ...
                            <div id="Transaction" className="tab-pane fade">
                              <div className="container">
                                <div className="table-responsive bg_card_section">
                                  ...
                                  <div className="d-flex justify-content-center prime_deposit">
                                    <button className="deposit_p">View more</button>
                                  </div>
                                </div>
                              </div>
                            </div>
