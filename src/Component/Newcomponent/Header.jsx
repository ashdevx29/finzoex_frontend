...
const App = () => {
  ...
  const currentRouteSegment = currentUrl.split("/")[3];
  // console.log(currentRouteSegment, "currentRouteSegment");
  const [authtoken, setauthtoken] = useState(false);
  const [Activestate, setActivestate, Activestateref] = useState(currentRouteSegment);
  ...
  const changeTheme = (value) => {
    ...
    document.body.classList.toggle("light", isOpenref.current);
    console.log("href path---", window.location.pathname.split("/"));
