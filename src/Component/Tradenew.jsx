...
function Home() {
  ...
  const [curnt_Ordertype_tab, setcurnt_Ordertype_tab,curnt_Ordertype_tabref] = useState("Limit");
    ...
    socket.on("TickerPrice", async (response) => {
      if (response.data) {
        ...
        if(curnt_Ordertype_tabref.current=="Stop")
        {
          ...
          ? parseFloat(tickerdetail.lastprice.lastprice).toFixed(pairDetailsref.current.price_decimal)
          : 0.0;
  ...
  const type_Ordertab_change = async (orderType) => {
    try {
      ...
      {
        formValue.price = "";
        formValue.stop_price = parseFloat(marketPrice).toFixed(pairDetailsref.current.price_decimal);
        //formValue.price = "";
      }
    ...
    try {
      ...
      if (fetchticker) {
        ...
        if(curnt_Ordertype_tabref.current=="Stop")
        {
          ...
          ? parseFloat(data.lastprice.lastprice).toFixed(pairDetailsref.current.price_decimal)
          : 0.0;
            //formValue.stop_price = "";
          }
          else
  ...
  const buildchart = (theme, pair) => {
    const widgetOptions = {
      ...
      height: "518",
      studies_overrides: {},
      loading_screen: {backgroundColor: "#313545"},
      theme: theme,
      toolbar_bg: "#313545",
      timezone: "Asia/Kolkata",
      overrides: {
        // "symbolWatermarkProperties.color": "#000657",
        "paneProperties.background": "#313545",
          ...
          <div className="row">
              ...
              <div className="market_palace trade_chart222">
                <div className="price_section">
                            ...
                            <div className="fixTableHead w-100">
                              <table>
                                ...
                                <tbody>
                                  <tr>
                                    <td>
                                      <span className="img_pair">BTC_SHIB</span>
                                    </td>
                                    <td>
                  ...
                  <div className="text_red">
                    ...
                    {isNaN(marketPrice)
                      ? ""
                      : parseFloat(marketPrice).toFixed(pairDetailsref.current.price_decimal) }{" "}
                  </div>
                </div>
            ...
            <div className="col-lg-2 trade-colpading d-flex">
              <div className="formplac card_light card_light-w">
                <div className="dropdown order-typr_ee">
                  <button
                    className="btn btn-primary dropdown-toggle"
                    type="button"
                    data-toggle="dropdown"
                  >
                    {curnt_Ordertype_tabref.current}
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <a
                        data-toggle="tab"
                        href="#home"
                        class={`${curnt_Ordertype_tabref.current=="Limit"?"active":""}`}
                    ...
                    <li>
                      <a
                        data-toggle="tab"
                        href="#menu1"
                        class={`${curnt_Ordertype_tabref.current=="Market"?"active":""}`}
                    ...
                    <li>
                      <a
                        data-toggle="tab"
                        href="#menu2"
                        class={`${curnt_Ordertype_tabref.current=="Stop"?"active":""}`}
                ...
                <div className="tab-content">
                  ...
                  <div id="home"  class={`${curnt_Ordertype_tabref.current=="Limit"?"tab-pane fade in active show":"tab-pane fade"}`}>
                  ...
                  <div id="menu1" class={`${curnt_Ordertype_tabref.current=="Market"?"tab-pane fade in active show":"tab-pane fade"}`} >
                    <div className="buysellform">
                      <ul className="nav nav-pills">
                        <li className="active">
                          <a
                  ...
                  <div id="menu2" className="tab-pane fade" class={`${curnt_Ordertype_tabref.current=="Stop"?"tab-pane fade in active show":"tab-pane fade"}`}>
                    <div className="buysellform">
                      <ul className="nav nav-pills">
                        <li className="active">
                          <a
                                        ...
                                        <div className="price_symbol">
                                          ...
                                          {obj.last_price <= 0 ? (
                                            <span className="text-red">
                                              {parseFloat(obj.lastprice).toFixed(pairDetailsref.current.price_decimal)}
                                            </span>
                                          ) : (
                                ...
                                <>
                                  <tr>
                                    <td onClick={() => pairChange(obj)}>
                                      ...
                                      >
                                        <img
                                        src={new URL("../img/kdx.png", import.meta.url).href}
                                        className="" />
                                        {obj.pair}
                                      </span>
                                    </td>
                                    ...
                                    {obj.pair === pair ? (
                                      ...
                                      >
                                        ...
                                        <div className="price_symbol">
                                          ...
                                          {obj.lastprice <= 0 ? (
                                            <span className="text-red">
                                              {parseFloat(obj.lastprice).toFixed(8)}
                                            </span>
                                          ) : (
                                            <span className="text-green">
                                              {parseFloat(obj.lastprice).toFixed(8)}
                              ...
                              return (
                                <tr>
                                    ...
                                    {item.tradeType == "buy" ? (
                                      <span className="text-green">
                                        ...
                                        {item.ordertype == "Stop" ? (
                                          ...
                                          parseFloat(item.stoporderprice).toFixed(4)
                                  ...
                                  {item.ordertype == "Stop" ? (
                                    ...
                                    parseFloat(item.filledAmount * item.stoporderprice).toFixed(4)

                                    ) : (
                                    parseFloat(item.filledAmount * item.price).toFixed(4)
                                    )
                        ...
                        <tbody>
                          {cancelOrders.length > 0 ? (
                            cancelOrders.map((item, i) => {
                              var total = (item.ordertype == "Stop") ? +item.filledAmount * +item.stoporderprice : +item.filledAmount * +item.price;
                              return (
                                <tr>
