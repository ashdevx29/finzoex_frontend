              ...
              <div className="col-lg-12 pading-zeero">
                <div className="p2ppost">
                  <ul className="nav nav-tabs">
                    <li className="active">
                      <a data-toggle="tab" href="#wanttobuy" className="active" onClick={() => tabSelect('buy')}>
                        I Want to Buy
                      </a>
                    </li>
                    <li>
                  ...
                  <div className="tab-content">
                    <div id="wanttobuy" className="tab-pane fade in active show">
                    ...
                    <div id="wanttosell" className="tab-pane fade ">
                      <div className="buyform_now">
                        <form className="row">
                          <div className="col-lg-4">
                            <div className="form-group">
