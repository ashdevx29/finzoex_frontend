              ...
              <div className="col-lg-10">
                <div className="staking_optoikn">
                  <ul className="nav nav-pills">
                    <li className="active">
                      <a data-toggle="pill" href="#Staking" className="active">
                        Fixed Staking
                      </a>
                    </li>
                    <li className="">
                                ...
                                ? stakeDetails.map((item, i) => {
                                    return (
                                      <tr>
                                        ...
                                        <td>
                                        <div className="aPY"> {item.APRinterest} % </div>
                                        </td>
                                ...
                                stakeHistory.map((item, i) => {
                                  ...
                                  return (
                                    <tr>
                                      ...
                                      <td>{startdate} </td>
                                      <td>{item.type == "fixed" ? item.stakingPlan+" days"  : '-'} </td>
                                      <td>
                                      <div className="type">
                                            <p>{item.type} </p>
                                          </div>
                                      ...
                                      <td> { item.type == "fixed" ? endtdate : "-"}</td>
                    ...
                    <div className="col-lg-3">
                      <div className="stakingtext_new">
                        <div className="type">
                          ...
                          <p> {stakingType == "fixed" ? "Lock" : "Flexibile"} </p>
                        </div>
                        <div className="minimum">
                          <p>
                            {" "}
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <div className="summery">
                        ...
                        <div>
                          <p>
                            Stake Date <span>{  stakingType == "fixed" ? fromDates : flexibleStartDate} </span>
                          </p>
                          <p>
                            Interest End Date <span>{ stakingType == "fixed" ? toDates : "-"} </span>
                          </p>
                          {/* <p>
